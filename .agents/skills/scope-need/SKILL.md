...
1. **Who is asking and why now?** MCP client maintainer report, operator request, CVE response, advisor-dispatched brief, or principal-direct scope?
...
## Driver
<MCP client / operator / CVE / advisor-brief / principal-direct>
...
## Appropriate owner
<lesser / host / Theory Cloud framework / separate new repo / scoping with the principal>
...
- **Advisor-dispatched** — `review-advisor-brief` already ran; output includes the principal's authorization.
