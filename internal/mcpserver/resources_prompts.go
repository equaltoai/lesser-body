...
func registerResources(srv *Server) error {
	...
	for _, res := range []struct {
		...
		{Def: resourceDef("agent://channels", "channels", "Communication channels"), Handler: resourceNotImplementedJSON("agent://channels")},
		{Def: resourceDef("agent://channels/preferences", "channels_preferences", "Channel preferences"), Handler: resourceNotImplementedJSON("agent://channels/preferences")},
		{Def: resourceDef("agent://email/inbox", "email_inbox", "Email inbox"), Handler: resourceNotImplementedJSON("agent://email/inbox")},
		{Def: resourceDef("agent://email/sent", "email_sent", "Sent email"), Handler: resourceNotImplementedJSON("agent://email/sent")},
		{Def: resourceDef("agent://sms/messages", "sms_messages", "SMS messages"), Handler: resourceNotImplementedJSON("agent://sms/messages")},
		{Def: resourceDef("agent://voicemail", "voicemail", "Voicemail"), Handler: resourceNotImplementedJSON("agent://voicemail")},
