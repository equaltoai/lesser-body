...
### AppTheory (pinned)
- Go module: `github.com/theory-cloud/apptheory/v2@v2.0.1`
- Go runtime import: `github.com/theory-cloud/apptheory/v2/runtime`
- TypeScript CDK package: `@theory-cloud/apptheory-cdk` release tarball `theory-cloud-apptheory-cdk-3.0.1.tgz`
- Runtime docs entrypoints (for tag `v2.0.1`):
...
- Copy/paste runtime dependency command:
  - `go get github.com/theory-cloud/apptheory/v2@v2.0.1`
- Recommended pinned runtime docs links:
  - `https://github.com/theory-cloud/AppTheory/blob/v2.0.1/docs/getting-started.md`
  - `https://github.com/theory-cloud/AppTheory/blob/v2.0.1/docs/integrations/agentcore-mcp.md`
  - `https://github.com/theory-cloud/AppTheory/blob/v2.0.1/docs/integrations/mcp.md`
  - `https://github.com/theory-cloud/AppTheory/blob/v2.0.1/docs/integrations/remote-mcp.md`
  - `https://github.com/theory-cloud/AppTheory/blob/v2.0.1/docs/migration/from-lift.md`
...
2) Initialize the Go module (if not already) and add pinned framework dependencies:
   - Add the AppTheory Go runtime at `v2.0.1`.
